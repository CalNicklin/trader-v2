...
const KNOWN_VALID_TICKERS = new Set([
	...
	"JPM", "V", "JNJ", "WMT", "PG", "MA", "HD", "XOM", "AVGO", "COST",
	"ABBV", "MRK", "PEP", "KO", "LLY", "NVO", "CRM", "AMD", "NFLX",
	"INTC", "CSCO", "ADBE", "PYPL", "QCOM", "TXN", "AMAT", "MU",
	"CRWD", "HPE", "LMT", "BA", "RTX", "GD", "NOC", "MBLY",
	"TSM", "BRK-B", "BRK-A",
	// LSE
	"SHEL", "BP.", "HSBA", "AZN", "ULVR", "VOD", "RIO", "GLEN",
	"GAW", "FDEV", "TET", "JET2", "BOWL", "FEVR",
]);
